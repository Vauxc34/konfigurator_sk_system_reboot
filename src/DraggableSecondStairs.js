...
const DraggableStairs = React.memo((props) => {
    ...
    useEffect(() => {
        ...
        if(props.direction === 'front'){
            if(LeftCorner > position[0] || RightCorner < position[0] || props.HeightHall - 20 < position[1] || -32.5 > position[1]){
            ...
            if(LeftCorner - 45 > position[0] || RightCorner - 45 < position[0] || props.HeightHall - 20  < position[1] || -32.5 > position[1]){
                console.log('element deleted')
                setDeletedColor(true)
                props.door.children[0].children[0].children[0].children[0].children[2].children[1].material.color.set(0xea8064);
                props.door.children[0].children[0].children[0].children[0].children[1].material.color.set(0xea8064);     
            ...
            if(LeftCorner + 50 > position[2] || RightCorner + 45 < position[2] || props.HeightHall - 20  < position[1] || -32.5 > position[1]){
                console.log('element deleted')
                setDeletedColor(true)
                props.door.children[0].children[0].children[0].children[0].children[2].children[1].material.color.set(0xea8064);
                props.door.children[0].children[0].children[0].children[0].children[1].material.color.set(0xea8064);     
            ...
            if(LeftCorner + 20 > position[2] || RightCorner + 25 < position[2] || props.HeightHall - 20 < position[1] || -32.5 > position[1]){
                console.log('element deleted')
                setDeletedColor(true)
                props.door.children[0].children[0].children[0].children[0].children[2].children[1].material.color.set(0xea8064);
                props.door.children[0].children[0].children[0].children[0].children[1].material.color.set(0xea8064);     
    ...
    useEffect(() => {
        ...
        props.door.children[0].children[0].children[0].children[0].children[1].material.color.set(parseInt(`0x${doorColor}`));
        props.door.children[0].children[0].children[0].children[0].children[2].children[1].material.color.set(parseInt(`0x${doorColor}`));
        props.stair.children[0].children[0].children[0].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[1].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[2].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[3].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[4].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[5].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[6].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[7].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[8].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[9].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[10].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[11].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[12].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[13].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[14].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[15].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[16].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[17].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[18].children[0].material.color.set(0x383e42)
        props.stair.children[0].children[0].children[19].children[0].material.color.set(0x383e42)
    ...
    <mesh
        ...
        {...bind()}
    >
        <primitive object={props.stair} scale={[35, 30, 35]} rotation={[0, 0, 0]}>
            <primitive object={props.door} scale={[.008, .009, .003]} rotation={[0, 0, 0]} position={[-0.32, 2.77, -1.92]}>
                {(show ? <group rotation={[0, 0, 0.8]} position={(props.direction === 'front' || props.direction === 'back' ? [50, 205, 15] : [50, 205, 15])} onClick={() => props.handleDeleteStairs(props.index)}>
                    <mesh>
