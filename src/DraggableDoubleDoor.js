...
function DraggableWindow(props) {
        ...
        ({ active, offset: [x, y] }) => {
            ...
            if(props.direction === 'front'){
                if(props.frontSideBool){
                    const [, y, z] = position;
                    setPosition([x / aspect, props.newposition.y + (props.ConstructionPosY - 2), props.ModelPos - sub - 7.5]);
                ...
                if(props.leftSideBool){
                    const [z, , ] = position;
                    setPosition([props.ModelPos + (sub - 6) + (props.obj === 'half' ? 8.5 : 7.3) , props.newposition.y + (props.ConstructionPosY - 2), x / aspect]);
                    props.setCameraMovement(!active);
                }
            }else if (props.direction === 'right'){
                if(props.rightSideBool){
                    const [z, , ] = position;
                    setPosition([props.ModelPos - (sub - 6) - 7.5, props.newposition.y + (props.ConstructionPosY - 2), -x / aspect]);
                    props.setCameraMovement(!active);
                }
            }
        },
    ...
    useEffect(() => {
        if(props.direction === 'front'){
            setPosition([position[0], props.newposition.y + (props.ConstructionPosY - 2), props.ModelPos - sub - 7.5]);
        }else if(props.direction === 'back'){
            setPosition([position[0], props.newposition.y + (props.ConstructionPosY - 2), props.ModelPos + sub + 7.5]);
        }else if(props.direction === 'left'){ 
            setPosition([props.ModelPos + (sub - 6) + (props.obj === 'half' ? 8.5 : 7.3), props.newposition.y + (props.ConstructionPosY - 2), position[2]]);
        }else if(props.direction === 'right'){
            setPosition([props.ModelPos - (sub - 6) - 7.5, props.newposition.y + (props.ConstructionPosY - 2), position[2]]);
        }
    ...
    useEffect(() => {
        if(typeArray[typeIdx] === 'none'){
            if(props.direction === 'left'){
                props.door.children[0].children[0].children[0].scale.set(1, 5, 1);
                props.door.children[0].children[0].children[1].scale.set(1, 5.5, 1);
                props.door.children[0].children[0].children[1].position.set(0, 0.275, 0);
                props.door.children[0].children[0].children[2].scale.set(1, 2, 1);
            }else{
                props.door.children[0].children[0].children[0].scale.set(1, 4, 1);
                props.door.children[0].children[0].children[1].scale.set(1, 4.5, 1);
                props.door.children[0].children[0].children[1].position.set(0, 0.15, 0);
                props.door.children[0].children[0].children[2].scale.set(1, 2, 1);
            }
        }else if(typeArray[typeIdx] === 'half'){
            console.log(props.third_door)
            if(props.direction === 'left'){
                props.third_door.children[0].children[0].children[0].scale.set(1, 5.5, 1);
                props.third_door.children[0].children[0].children[1].scale.set(1, 7.5, 1);
                props.third_door.children[0].children[0].children[1].position.set(2.5, -0.8, 0);
                props.third_door.children[0].children[0].children[2].scale.set(1, 2.8, 1);
            }else{
                props.third_door.children[0].children[0].children[0].scale.set(1, 5, 1);
                props.third_door.children[0].children[0].children[1].scale.set(1, 6.5, 1);
                props.third_door.children[0].children[0].children[1].position.set(2.5, -0.7, 0);
                props.third_door.children[0].children[0].children[2].scale.set(1, 2.5, 1);
            }

        }else if(typeArray[typeIdx] === 'full'){
            if(props.direction === 'left'){
                props.second_door.children[3].children[0].children[0].scale.set(1, 5, 1);
                props.second_door.children[3].children[0].children[1].scale.set(1, 7.5, 1);
                props.second_door.children[3].children[0].children[1].position.set(0, 0.4, 0);
                props.second_door.children[3].children[0].children[2].scale.set(1, 2.5, 1);
            }else{
                props.second_door.children[3].children[0].children[0].scale.set(1, 5, 1);
                props.second_door.children[3].children[0].children[1].scale.set(1, 6.5, 1);
                props.second_door.children[3].children[0].children[1].position.set(0, 0.3, 0);
                props.second_door.children[3].children[0].children[2].scale.set(1, 2.5, 1);
            }
        }
    }, [typeIdx])
    ...
    useEffect(() => {
        ...
        if(props.direction === 'front'){
            if(LeftCorner > position[0] || RightCorner < position[0] || props.HeightHall < position[1] || -32.5 > position[1]){
                ...
                if(typeArray[typeIdx] === 'none'){
                    props.door.children[0].children[0].children[0].material.color.set(0xea8064);
                    props.door.children[0].children[0].children[1].material.color.set(0xea8064);
                }else if(typeArray[typeIdx] === 'half'){
                    props.third_door.children[0].children[0].children[0].material.color.set(0xea8064);
                    props.third_door.children[0].children[0].children[1].material.color.set(0xea8064);
                }else if(typeArray[typeIdx] === 'full'){
                    props.second_door.children[3].children[0].children[0].material.color.set(0xea8064);
                    props.second_door.children[3].children[0].children[1].material.color.set(0xea8064);                
                }
                if(!activeDraggable){
                ...
                if(typeArray[typeIdx] === 'none'){
                    //props.door.children[0].children[0].children[0].material.color.set(parseInt(`0x${doorColor}`));
                    //props.door.children[0].children[0].children[1].material.color.set(parseInt(`0x${doorColor}`));
                }else if(typeArray[typeIdx] === 'half'){
                    props.third_door.children[0].children[0].children[0].material.color.set(parseInt(`0x${doorColor}`));
                    props.third_door.children[0].children[0].children[1].material.color.set(parseInt(`0x${doorColor}`));
                }else if(typeArray[typeIdx] === 'full'){
                    props.second_door.children[3].children[0].children[0].material.color.set(parseInt(`0x${doorColor}`));
                    props.second_door.children[3].children[0].children[1].material.color.set(parseInt(`0x${doorColor}`));                
                }
            }
        }else if(props.direction === 'back'){
            if(LeftCorner - 60 > position[0] || RightCorner - 80 < position[0] || props.HeightHall < position[1] || -32.5 > position[1]){
                console.log('element deleted')
                setDeletedColor(true)
                if(typeArray[typeIdx] === 'none'){
                    props.door.children[0].children[0].children[0].material.color.set(0xea8064);
            ...
            if(LeftCorner + 80 > position[2] || RightCorner + 60 < position[2] || props.HeightHall < position[1] || -32.5 > position[1]){
                console.log('element deleted')
                setDeletedColor(true)
                if(typeArray[typeIdx] === 'none'){
                    props.door.children[0].children[0].children[0].material.color.set(0xea8064);
            ...
            if(LeftCorner + 10 > position[2] || RightCorner - 10 < position[2] || props.HeightHall + 10 < position[1] || -32.5 > position[1]){
                console.log('element deleted')
                setDeletedColor(true)
                if(typeArray[typeIdx] === 'none'){
                    props.door.children[0].children[0].children[0].material.color.set(0xea8064);
    ...
    }, [props.HeightHall, LeftCorner, RightCorner, position, props.door, props.DoorColor1])
    ...
    useEffect(() => {
        ...
        if(typeArray[typeIdx] === 'none'){
            props.door.children[0].children[0].children[0].material.color.set(parseInt(`0x${doorColor}`));
            props.door.children[0].children[0].children[1].material.color.set(parseInt(`0x${doorColor}`));
            props.door.children[0].children[0].children[2].material.color.set(parseInt(`0x${obrobkaDrzwi}`));
        }else if(typeArray[typeIdx] === 'half'){
            props.third_door.children[0].children[0].children[0].material.color.set(parseInt(`0x${doorColor}`));
            props.third_door.children[0].children[0].children[1].material.color.set(parseInt(`0x${doorColor}`));
            props.third_door.children[0].children[0].children[2].material.color.set(parseInt(`0x${obrobkaDrzwi}`));
            props.third_door.children[0].children[0].children[3].material.color.set(parseInt(`0x${obrobkaDrzwi}`));
        }else if(typeArray[typeIdx] === 'full'){
            props.second_door.children[3].children[0].children[0].material.color.set(parseInt(`0x${doorColor}`));
            props.second_door.children[3].children[0].children[1].material.color.set(parseInt(`0x${doorColor}`));    
            props.second_door.children[3].children[0].children[2].material.color.set(parseInt(`0x${obrobkaDrzwi}`));    
            props.second_door.children[3].children[0].children[3].material.color.set(parseInt(`0x${obrobkaDrzwi}`));    
        }
    ...
    useEffect(() => {
        if(props.direction === 'front'){
            setPosition([props.newposition.x + props.x, props.newposition.y, props.ModelPos - sub - 7.5]);
        }else if(props.direction === 'back'){
            setPosition([props.newposition.x - 67 - props.x, props.newposition.y, props.ModelPos + sub + 7.5]);
        }else if(props.direction === 'left'){
            setPosition([props.ModelPos  + (sub - 6) + (props.obj === 'half' ? 8.5 : 7.3), props.newposition.y, props.newposition.z + props.x]);
        }else if(props.direction === 'right'){
            setPosition([props.ModelPos - (sub - 6) - 7.5, props.newposition.y, props.newposition.z - 67 + props.x]);
        }
    }, [props.x, props.y])
    ...
    return (
        ...
        <mesh
            ...
            {...bind()}
        >
            <primitive ref={modelRef} object={(typeArray[typeIdx] == "half" ? props.third_door : (typeArray[typeIdx] == "full" ? props.second_door : props.door))}>
            <group>
                {(show ? <group position={(props.direction === 'front' || props.direction === 'back' ? [1.67, 2.02, 0.45] : [1.67, 2.02, 0.45])} rotation={[0, 0, 0.8]} onClick={() => props.handleDeleteDoor(props.index)}>
                    <mesh>
                ...
                {(show ? <group position={(props.direction === 'front' || props.direction === 'back' ? [-2.23, 1.96, 0.45] : [-2.23, 1.96, 0.45])} rotation={[0, 0, 0.8]} onClick={() => changeType()}>
                    <mesh position={[3, -3, 0]}>
                    ...
                    <mesh position={[3.02, -2.97, 0]}> {/* Dodaj strzałkę jako mesh */}
                        <boxBufferGeometry args={[0.03, 0.13, 0.01]} />
                        <meshBasicMaterial color="white" />
                    </mesh>
                    <mesh position={[2.97, -3.02, 0]} rotation={[0, 0, Math.PI / 2]}> {/* Dodaj strzałkę jako mesh */}
                        <boxBufferGeometry args={[0.03, 0.13, 0.01]} />
                        <meshBasicMaterial color="white" />
                    </mesh>
                </group> : '')}
                ...
                <>
                    <mesh renderOrder={0} position={[0.45, 1.55, (props.direction === 'left' ? 0.20 : 0.19)]}>
                        <boxBufferGeometry args={[0.65, 0.9, (props.direction === 'left' ? .175 : .15)]}    />
                    ...
                    <mesh renderOrder={0} position={[1.25, 1.55, (props.direction === 'left' ? 0.20 : 0.19)]}>
                        <boxBufferGeometry args={[0.65, 0.9, (props.direction === 'left' ? .175 : .15)]}    />
                        <meshPhysicalMaterial colorManagement={true} linear={false}  color={'#ffffff'} side={THREE.DoubleSide} opacity={0.125} transparent={true} roughness={0} metalness={0.5} transmission={1} ior={2.33} />
                    </mesh>
                </>
                : null
                }
                ...
                <>
                    <mesh renderOrder={0} position={[0.45, 1, (props.direction === 'left' ? 0.17 : 0.19)]}>
                        <boxBufferGeometry args={[0.65, 1.9, (props.direction === 'left' ? .20 : .15)]}    />
                        <meshPhysicalMaterial colorManagement={true} linear={false} color={'#ffffff'} side={THREE.DoubleSide} opacity={.125} transparent={true} roughness={0} metalness={0.5} transmission={1} ior={2.33}/>
                    </mesh>

                    <mesh renderOrder={0} position={[1.25, 1, (props.direction === 'left' ? 0.17 : 0.19)]}>
                        <boxBufferGeometry args={[0.65, 1.9, (props.direction === 'left' ? .20 : .15)]}    />
                        <meshPhysicalMaterial colorManagement={true} linear={false} color={'#ffffff'} side={THREE.DoubleSide} opacity={.125} transparent={true} roughness={0} metalness={0.5} transmission={1} ior={2.33}/>
                    </mesh>
                </>
